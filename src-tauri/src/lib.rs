...
use commands::{get_all_sessions, focus_session, update_tray_title, register_shortcut, unregister_shortcut, kill_session, get_session_history, resume_session, delete_history_session, open_in_editor, archive_session, update_tray_menu, get_session_events};
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![get_all_sessions, focus_session, update_tray_title, register_shortcut, unregister_shortcut, kill_session, get_session_history, resume_session, delete_history_session, open_in_editor, archive_session, update_tray_menu, get_session_events])
        .setup(|app| {
